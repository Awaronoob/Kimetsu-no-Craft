package net.awaronoob.kimetsucraft.world;
...
public class ModPlacedFeatures {
    ...
    public static final RegistryKey<PlacedFeature> SCARLET_ORE_PLACED_PLACED_KEY = registerKey("scarlet_ore_placed");
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(MID, name));
    }
